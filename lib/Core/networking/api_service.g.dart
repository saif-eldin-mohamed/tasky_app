...
class _ApiService implements ApiService {
  ...
  Future<RefreshTokenResponse> refreshToken(String refreshToken) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'token': refreshToken};
    final _headers = <String, dynamic>{};
    ...
    final _value = RefreshTokenResponse.fromJson(_result.data!);
    return _value;
  }

  @override
  Future<List<TodoResponse>> getTodosList(int pageNum) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<void> createTask(AddEditTaskRequestBody addEditTaskRequestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(addEditTaskRequestBody.toJson());
  ...
  @override
  Future<TodoResponse> getTodoById(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<void> editTask(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(editTaskRequestBody.toJson());
    await _dio.fetch<void>(_setStreamType<void>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
